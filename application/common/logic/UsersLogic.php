...
class UsersLogic extends Model
{
    ...
    public function get_order_goods($order_id){
        $sql = "SELECT og.rec_id, og.title, og.goods_num, og.goods_price, g.goods_id, g.original_img FROM __PREFIX__order_goods og LEFT JOIN __PREFIX__goods g ON g.goods_id = og.goods_id WHERE order_id = :order_id";
