...
class CartLogic extends Model
{
    ...
    public function getCartList($selected = 0){
        ...
        $cartList = $cart->field('id, goods_num, goods_name,goods_sn,sku, goods_price, member_goods_price, selected,prom_type, goods_id')
                        ->with(['promGoods', 'goods'=>function($query){
                            $query->field('goods_id, goods_name, subtitle, shop_price, original_img, is_on_sale, cat_id, city_code');
                        }])
